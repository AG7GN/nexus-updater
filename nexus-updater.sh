...
CheckDepInstalled "extra-xdg-menus bc dnsutils libgtk-3-bin jq xdotool moreutils exfat-utils build-essential autoconf automake libtool checkinstall git aptitude"
...
EOF
		...
		qsstv)
         ...
         LATEST_VERSION="qsstv/${TAR_FILE%.tar.gz}"
